...
function buscarImagenes(){
    ...
    const key = '23790180-0b2f9bf449dbc4b3cda10cbf7'
...
// geenrador que va a registar la cantidad de elementos de a cuerdo a la cantidad de paginas
        ...
        <div class="w-1/2 md:w-1/3 lg:w-1/4 p-3 mb-4">
            <div class="bg-white">        
                ...
                <div class="p-4">
                    ...
                    <a 
                        class="block w-full bg-blue-800 text-white upperase font-bold text-center rouded mt-5 p-1"
